...
*/
let lastPets = pets.shift()
lastPets = pets.push('dog')
console.log(pets)
// nella console da due volte dog perche con gli esercizi di prima ho modificato l'ordine dell'array
/* ESERCIZIO 5
...
for (let i= 0; i < cars.length; i++) {
  cars[i][addLicensePlate] = licensePlate
}
...
*/
for(let i = 0; i < cars.length; i++){
  let firstletter = cars[i].color[0]
  if (firstletter === 'b') {
    console.log('fizz')
  } else {
    console.log('buzz')
